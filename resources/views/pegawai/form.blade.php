<div class="form-group">
    ...
    <div class="col-md-4">
        {{ Form::text('nama', $pegawai->name ?? old('nama'), ['placeholder'=>'e.g. Wahyu Nugroho','class'=>'form-control']) }}
    </div>
</div>
<div class="form-group">
    {{ Form::label('email', 'Email &nbsp;', ['class'=>'control-label col-md-2']) }}
    <div class="col-md-4">
        {{ Form::email('email', $pegawai->user->email ?? old('email'), ['placeholder'=>'e.g. korodarmo@gmail.com','class'=>'form-control']) }}
    </div>
</div>
<div class="form-group">
