...
class PegawaiController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $data['pegawais'] = $pegawai->paginate(10);
    ...
    {
        $data['jabatan']    = Jabatan::pluck('name', 'id')->prepend('Silahkan Pilih Jabatan',0);
        $data['departemen'] = Departemen::pluck('name', 'id')->prepend('Silahkan Pilih Departemen',0);
